...
double adb1(double x[],int r,int c,int i,int j,int q){
	double mfb1 = 1/PC(2,r) + 2/PC(3,r) + 2/PC(4,r);
	double mfb2 = 2/PC(3,r) + 3/PC(4,r);
	double mfb3 = 1/PC(4,r);
	double sband1 = 0;
...
double sband1 = 0, sum1, penalty1 = 0;
double mfb1 = (1 / PC(2,r)) + (2 / PC(3,r)) + (2 / PC(4,r));
double mfb2 = (2 / PC(3,r)) + (3 / PC(4,r));
double mfb3 =  1 / PC(4,r);
double c1 = (1 / PC(2,r)) + (2 / PC(3,r)) + (1 / PC(4,r));
double c2 = (1 / PC(3,r)) + (1 / PC(4,r));
double c3 = (1 / PC(3,r)) + (2 / PC(4,r));
double c4 =  1 / PC(4,r);
